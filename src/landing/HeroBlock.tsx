...
const useStyles = makeStyles(theme => ({
    heroBlock: {
        backgroundImage: `url(https://i.postimg.cc/c1kN5LbW/background-Small.jpg)`,
        ...
        [theme.breakpoints.up("sm")]: {
            backgroundImage: `url(https://i.postimg.cc/WzyLD5kz/background-Medium.jpg)`,
            height: 750
        },
        [theme.breakpoints.up("md")]: {
            backgroundImage: `url(https://i.postimg.cc/hvvRPkhN/background-Big.jpg)`,
            height: "120vh",
